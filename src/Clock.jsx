...
function Clock({ seconds, minutes, hours }) {
    ...
    return (
        <>
            <p className="ANALOGWATCHTEXT"> ANALOG WATCH</p>
            <div className='clock'>
                <div className='hand hour' style={{ transform: `translate(-50%) rotate(${hours * 360}deg)` }}></div>
                <div className='hand minute' style={{ transform: `translate(-50%) rotate(${minutes * 360}deg)` }}></div>
                <div className='hand second' style={{ transform: `translate(-50%) rotate(${seconds * 360}deg)` }}></div>
